...
public class AppWithChallengeURL {
	public static void main(String[] args) throws InterruptedException, AWTException, IOException {
		...
		try {
			driver.get("https://www.hackerrank.com/domains/java/java-strings/2");
			...
			for (int y = 0; y < href_links.size(); y++) {
				...
				if (webele.size() != 0) {
					...
					String code = driver.findElement(By.xpath(
							"//*[@id=\"content\"]/div/div[2]/div/div[4]/div/div[2]/section/div[3]/div[2]/div[2]/div/div[6]/div[1]/div/div"))
							.getText();
					...
					if (!f.exists())
						f.mkdir();
					PrintWriter out = new PrintWriter(root + challenge + "/Solution.sql");
